...
var id=1;var startTimeJobs;var allJobs=[];function createQueue(){var newJob=new JobStruct(id,$('#time').val());allJobs.push(newJob);id++;$('.table-logs').append("<li>Job "+newJob.jobId+" adicionado a fila. Tempo de execu\u00e7\u00e3o: "+newJob.totalTime+" segundos </li>");}
function startJobs(){$('.table-logs').append("<li>Iniciando execu\u00e7\u00e3o dos Jobs.</li>");for(var i=0;i<allJobs.length;i++){if(i==0){startTimeJobs=new Date().getTime();}
...
function JobStruct(jobId,totalTime){this.jobId=jobId;this.totalTime=totalTime;}
