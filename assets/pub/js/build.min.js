...
var id=1;var startTimeJobs;var allJobs=[];var jobsToExecute=[];function createQueue(){var newJob=new JobStruct(id,$('#time').val());allJobs.push(newJob);jobsToExecute.push(newJob);id++;$('.table-logs').append("<li class='list-group-item'>Job "+newJob.jobId+" adicionado a fila. Tempo de execução: "+newJob.totalTime+" segundos </li>");}
