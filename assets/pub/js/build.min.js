...
function cleanScheduler(){$('#cleanScheduler').on('click',function(){$('#sectionGraphic').hide();$('#sectionCalculo').hide();toast(messages.alert.restartScheduler,messages.color.success);});}'use strict';$(document).ready(()=>{init();});const init=()=>{$('[data-toggle="tooltip"]').tooltip();}