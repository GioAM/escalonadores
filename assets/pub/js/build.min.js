...
var worker=new Worker('../../../assets/dev/js/sleep-worker.js');console.log(worker);worker.postMessage('sleepSch');$(document).ready(function(){$('[data-toggle="tooltip"]').tooltip();cleanScheduler();});function JobStruct(jobId,totalClocks,priority){this.jobId=jobId;this.totalClocks=totalClocks;this.executed=false;this.priority=priority;}
